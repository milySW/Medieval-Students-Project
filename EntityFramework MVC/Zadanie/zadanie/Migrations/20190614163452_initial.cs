        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AmountOfPublications = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Professors_Campuses_CampusId",
                        column: x => x.CampusId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Publications_Professors_ProfessorId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AmountOfHours = table.Column<int>(nullable: false),
                    ECTS = table.Column<int>(nullable: false),
                    PassRate = table.Column<int>(nullable: false),
                    ProfessorId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Professors_CampusId",
                table: "Professors",
                column: "CampusId");

            migrationBuilder.CreateIndex(
                name: "IX_Publications_ProfessorId",
                table: "Publications",
                column: "ProfessorId");
